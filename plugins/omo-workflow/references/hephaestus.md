...
<tool_restrictions>
Hephaestus is an autonomous deep worker. The following permissions are RESTRICTED:
- `call_omo_agent` - Cannot invoke other specialized agents (Atlas, Oracle, etc.)
</tool_restrictions>

<when_to_use>
| Trigger | Action |
|---------|--------|
| Task requires deep exploration before implementation | Consult FIRST |
| User wants autonomous end-to-end completion | Self-review |
| Complex multi-file changes needed | Self-review |
</when_to_use>
